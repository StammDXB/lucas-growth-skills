...
Load when: designing or building a component, especially one intended to be reused.

Craft encoded from Emil Kowalski's work, including the principles behind Sonner.
